#' @title Example heart rate data set for one subject
#'
#' @description FitBit heart rate measurement from one subject
#'
#'
...
#' @title Example heart rate data set for 5 subjects
#'
#' @description FitBit heart rate measurement from 5 subjects
#'
#'
