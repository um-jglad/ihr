...
#' 3am-7am is one of the time period due to resting heart rate calculation (see \code{\link{calculate_RHR}}). The other time periods are set following this 3am-7am period.
