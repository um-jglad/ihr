...
sedentary/sleep (<20% HRR + RHR), light (20–39% HRR + RHR), moderate (40–59% HRR + RHR), and vigorous (≥60% HRR + RHR)

For the episode calculation, to make sure our calculations for the episode are accurate, we use the definition:
