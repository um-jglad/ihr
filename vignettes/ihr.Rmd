...
ihr comes with example data from 14 subjects whose heart rate were tracked with FitBit devices. This data is publically available from [kaggle](https://www.kaggle.com/datasets/arashnic/fitbit/versions/1/data)
